...
{
    public class ExamHistoryEssayData : DataLibBase
    {
        ...
        /// 表名。
        /// </summary>
        public const string ExamHistoryEssay = "ExamHistoryEssay";
        
        private void BuildData()
        {
            DataTable dt = new DataTable(ExamHistoryEssay);
            ...
            dt.Columns.Add(score, typeof(System.Int32));
            ...
            dt.TableName = ExamHistoryEssay;
            this.Tables.Add(dt);
            this.DataSetName = "TExamHistoryEssay";
        }

        public ExamHistoryEssayData()
        {
            this.BuildData();
        }
    }
