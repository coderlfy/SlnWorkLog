...
{
    public class ExamAnswerEstimateData : DataLibBase
    {
        ...
        /// 表名。
        /// </summary>
        public const string ExamAnswerEstimate = "ExamAnswerEstimate";
        
        private void BuildData()
        {
            DataTable dt = new DataTable(ExamAnswerEstimate);
            ...
            dt.TableName = ExamAnswerEstimate;
            this.Tables.Add(dt);
            this.DataSetName = "TExamAnswerEstimate";
        }

        public ExamAnswerEstimateData()
        {
            this.BuildData();
        }
    }
