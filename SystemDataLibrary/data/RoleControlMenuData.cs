...
{
    public class RoleControlMenuData : DataLibBase
    {
        ...
        /// 表名。
        /// </summary>
        public const string RoleControlMenu = "RoleControlMenu";
        
        private void BuildData()
        {
            DataTable dt = new DataTable(RoleControlMenu);
            ...
            dt.TableName = RoleControlMenu;
            this.Tables.Add(dt);
            this.DataSetName = "TRoleControlMenu";
        }

        public RoleControlMenuData()
        {
            this.BuildData();
        }
    }
