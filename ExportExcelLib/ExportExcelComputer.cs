...
{
    public class ExportExcelComputer
    {
        ...
        public ExportExcelComputer(string filename, DataSet datasetExport, ExtjsGrid gridpanel)
        {
            #region
        ...
        private void BindDataAndStyle(Cells excelCells)
        {
            ...
            excelCells.Merge(0, 0, 2, 12);//合并单元格 
            excelCells[0, 0].SetStyle(titleStyle);
            excelCells[0, 0].PutValue("计算机参数信息");
