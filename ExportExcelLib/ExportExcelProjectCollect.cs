...
{
    public class ExportExcelProjectCollect
    {
        ...
        public ExportExcelProjectCollect(string filename, DataSet datasetExport, ExtjsGrid gridpanel)
        {
            #region
        ...
        private void BindDataAndStyle(Cells excelCells)
        {
            ...
            excelCells.Merge(0, 0, 2, 10);//合并单元格 
            excelCells[0, 0].SetStyle(titleStyle);
            excelCells[0, 0].PutValue("工程部发布汇总信息");
