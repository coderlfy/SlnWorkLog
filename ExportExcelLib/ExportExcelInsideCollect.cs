...
{
    public class ExportExcelInsideCollect
    {
        ...
        public ExportExcelInsideCollect(string filename, DataSet datasetExport, ExtjsGrid gridpanel)
        {
            #region
        ...
        private void BindDataAndStyle(Cells excelCells)
        {
            ...
            excelCells[0, 0].PutValue("内部发布汇总信息");
