...
{
    public class ExportExcelProductionCollect
    {
        ...
        public ExportExcelProductionCollect(string filename, DataSet datasetExport, ExtjsGrid gridpanel)
        {
            #region
        ...
        private void BindDataAndStyle(Cells excelCells)
        {
            ...
            excelCells[0, 0].PutValue("生产部发布汇总信息");
